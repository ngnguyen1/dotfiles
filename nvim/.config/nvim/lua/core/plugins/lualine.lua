...
-- =============================================================================
-- To add a component, insert it into the relevant section table.
-- You can do this in a separate file that merges with opts, e.g.:
--
...
--   }
--
-- ── Show lazy.nvim pending updates ───────────────────────────────────────
--
--   {
